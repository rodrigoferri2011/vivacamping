...
export const products: Product[] = [
  ...
  {
    id: "specs-barraca",
    name: "Espeques de Barraca",
    shortDescription: "Linha completa com 7 modelos de espeques em ferro para fixação profissional de barracas e estruturas.",
    price: "A partir de R$ 5,00",
    description:
      "Garanta uma fixação firme, segura e profissional para qualquer tipo de montagem com a Linha Completa de Espeques Viva Camping. Desenvolvidos para atender diferentes necessidades no campismo, esses 7 modelos de espeques foram pensados para oferecer máxima resistência, versatilidade e durabilidade, seja em areia, terra ou grama.\n\nCada modelo possui uma função específica, permitindo que você tenha sempre a solução ideal para fixar barracas, lonas, ráfias, tarps e estruturas completas com total segurança. Produzidos com ferro de alta qualidade, os espeques Viva Camping suportam condições exigentes e garantem estabilidade mesmo em ambientes desafiadores.\n\n💡 Dica: Ter os espeques certos faz toda diferença na segurança e estabilidade do seu camping — escolha o modelo ideal para cada tipo de solo e estrutura.",
    specs: [
      { label: "Espeque em L · 10 cm · ferro 3/16", value: "Fixação de ráfias e itens leves — R$ 5,00/un" },
      { label: "Espeque Argola · 35 cm · ferro 1/4", value: "Elásticos em lonas e tarps (areia) — R$ 15,00/un" },
      { label: "Espeque Argola · 25 cm · ferro 1/4", value: "Elásticos em grama ou terra — R$ 13,00/un" },
      { label: "Espeque Argola · 20 cm · ferro 1/4", value: "Elásticos em grama ou terra — R$ 11,00/un" },
      { label: "Espeque em L · 35 cm · ferro 5/16", value: "Fixação de barracas (areia) — R$ 30,00/un" },
      { label: "Espeque Argola · 40 cm · ferro 5/16 + olhal 6mm", value: "Postes de pequenas coberturas — R$ 40,00/un" },
      { label: "Espeque Cantoneira · 40 cm · cantoneira 3/16 + olhal 10mm", value: "Postes de grandes coberturas — R$ 50,00/un" },
    ],
